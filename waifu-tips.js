...
function loadWidget(waifuPath, apiPath) {
	...
	function registerEventListener() {
		...
		$("#waifu-tool .fa-info-circle").click(function () {
			open("https://github.com/ttop5/live2d-widget");
		});
	...
	function welcomeMessage() {
		...
		if (location.href == SiteIndexUrl) { //如果是主页
			...
			if (location.hostname == referrer.hostname) text = '来了老弟~';
			...
			else if (domain == "google") text = `Hello！来自 谷歌搜索 的朋友<br/>欢迎围观<span style="color:#0099cc;">『${document.title.split(" - ")[0]}』</span>`;
